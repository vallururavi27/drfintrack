...
console.log('This script will help you update your Firebase credentials in the .env file.');
...
// Main function
async function updateFirebaseCredentials() {
  try {
    ...
    const confirm = await prompt('\nDo you want to update these credentials in your .env file? (y/n): ');
    if (confirm.toLowerCase() !== 'y') {
      console.log('Operation cancelled.');
      return;
    }
    
    // Remove existing Firebase credentials from .env file
    ...
    console.log('\nFirebase credentials updated successfully in your .env file!');
