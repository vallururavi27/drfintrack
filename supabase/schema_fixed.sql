...
-- Default categories template (no foreign key constraint)
...
VALUES 
  ('Food', 'expense', '#FF5733', 'food'),
  ('Transportation', 'expense', '#33FF57', 'car'),
  ('Housing', 'expense', '#3357FF', 'home'),
  ('Entertainment', 'expense', '#F033FF', 'entertainment'),
  ('Healthcare', 'expense', '#FF3333', 'health'),
  ('Education', 'expense', '#33FFF3', 'education'),
  ('Shopping', 'expense', '#FFC733', 'shopping'),
  ('Utilities', 'expense', '#33FFBD', 'utilities'),
  ('Salary', 'income', '#33FF57', 'salary'),
  ('Investments', 'income', '#3357FF', 'investments'),
  ('Gifts', 'income', '#F033FF', 'gift'),
  ('Other', 'income', '#FF3333', 'other');
